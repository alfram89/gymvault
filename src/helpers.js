...
export const CARDIO_PICKER = { duration: { min: 0, max: 120, step: 1 }, distance: { min: 0, max: 100, step: 0.1 }, speed: { min: 0, max: 40, step: 0.1 }, incline: { min: 0, max: 30, step: 1 }, calories: { min: 0, max: 2000, step: 5 }, heart_rate: { min: 40, max: 220, step: 1 }, resistance: { min: 0, max: 30, step: 1 } }
